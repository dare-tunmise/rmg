<?php get_header() ?>
    <section class="hero">
        ...
        <div class="cta-buttons animate-fadeInUp">
            <a href="<?php echo site_url('/about') ?>" style="text-decoration: none; color: #000000;"><button class="primary-cta">Read Full Bio<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg></button></a>
            <!-- <a href="<?php echo site_url('/about') ?>"><button class="secondary-cta">Contact</button></a> -->
        </div>
        </div>
    </section>
